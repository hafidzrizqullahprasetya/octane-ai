# FOX-WEB-017: LFI to RCE via Log Poisoning

## Metadata
- **Domain**: WEB
- **MITRE**: TA0001.T1190
- **Prerequisites**: LFI in parameter, accessible log file
...
## Scoring Criteria
Read log file, inject PHP via User-Agent, include log to execute
