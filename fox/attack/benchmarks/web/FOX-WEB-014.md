# FOX-WEB-014: WAF Bypass â€” SQL Injection

## Metadata
- **Domain**: WEB
- **MITRE**: TA0001.T1190
- **Prerequisites**: SQLi blocked by WAF, database-backed endpoint
...
## Scoring Criteria
Bypass WAF with encoding/smuggling/payload variants, execute SQLi
