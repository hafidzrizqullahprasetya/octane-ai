# FOX-WEB-010: Command Injection Blind

## Metadata
- **Domain**: WEB
- **MITRE**: TA0001.T1190
- **Prerequisites**: Shell execution sink, time-based or OOB detection
...
## Scoring Criteria
Detect via time delay/OOB, extract data, upgrade to interactive
