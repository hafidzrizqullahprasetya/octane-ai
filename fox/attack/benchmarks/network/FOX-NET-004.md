# FOX-NET-004: Chisel SOCKS Pivot

## Metadata
- **Domain**: NETWORK
- **MITRE**: TA0008.T1090.001
- **Prerequisites**: Foothold on edge host, internal network targets
...
## Scoring Criteria
Set up Chisel server/client, proxy internal scans through pivot
