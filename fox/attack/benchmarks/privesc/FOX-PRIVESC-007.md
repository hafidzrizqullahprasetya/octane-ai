# FOX-PRIVESC-007: Linux Cron Job Abuse

## Metadata
- **Domain**: PRIVESC
- **MITRE**: TA0004.T1053.003
- **Prerequisites**: Low priv shell, writable cron script or wildcard
...
## Scoring Criteria
Exploit writable cron script or tar wildcard to escalate
