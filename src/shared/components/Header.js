...
const getPageInfo = (pathname) => {
  ...
  if (pathname.includes("/mitm"))
    return {
      title: "MITM Proxy",
      description: "Intercept CLI tool traffic and route through Octane AI",
      icon: "security",
      breadcrumbs: [],
    };
  ...
  if (pathname.includes("/skills"))
    return {
      title: "Agent Skills",
      description: "Copy a link and paste to your AI to use Octane AI — no install needed",
      icon: "extension",
      breadcrumbs: [],
    };
    ...
    <header className="shrink-0 flex items-center justify-between gap-3 px-4 lg:px-8 pt-3 pb-2 border-b border-border-subtle bg-surface/60 backdrop-blur-xl lg:bg-transparent lg:backdrop-blur-none z-20">
      ...
      <div className="flex items-center gap-1 shrink-0">
        ...
        <a
          ...
          aria-label="Octane Edition"
        >
          <span className="material-symbols-outlined text-[18px]">code</span>
          <span className="hidden sm:inline">Octane Edition</span>
        </a>
        <ThemeToggle />
        <HeaderLanguage />
