...
export const PROVIDER_CAPABILITIES = {
  ...
  "fb": {
    "openai/gpt-5.6-luna": { vision: true, reasoning: true, thinkingFormat: "openai" },
    "gpt-5.6-luna": { vision: true, reasoning: true, thinkingFormat: "openai" },
    "openai/gpt-5.6-luna-es": { vision: true, reasoning: true, thinkingFormat: "openai" },
    "gpt-5.6-luna-es": { vision: true, reasoning: true, thinkingFormat: "openai" },
