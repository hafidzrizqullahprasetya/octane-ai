...
export const PROVIDER_CAPABILITIES = {
  ...
  "fb": {
    ...
    "openai/gpt-5.6-luna-es": { vision: true, reasoning: true, thinkingFormat: "openai", contextWindow: 1000000, maxOutput: 128000 },
    ...
    "meta/muse-spark-1.3-contributor": { vision: true, reasoning: true, thinkingFormat: "openai" },
    "muse-spark-1.3-contributor": { vision: true, reasoning: true, thinkingFormat: "openai" },
    "meta/muse-spark-1.3": { vision: true, reasoning: true, thinkingFormat: "openai" },
    "muse-spark-1.3": { vision: true, reasoning: true, thinkingFormat: "openai" },
    ...
    "deepseek-v4-pro": { vision: false, reasoning: true, thinkingFormat: "openai" },
    "minimax/mimo-v2.5-free": { vision: true },
    "mimo-v2.5-free": { vision: true },
    "mimo/mimo-v2.5": { vision: true },
    "mimo-v2.5": { vision: true },
    "minimax/minimax-m3": { vision: true },
    "minimax-m3": { vision: true },
    "z-ai/glm-5.2": { vision: false, reasoning: true, thinkingFormat: "openai" },
    "glm-5.2": { vision: false, reasoning: true, thinkingFormat: "openai" },
    "anthropic/claude-fable-5": { vision: true, reasoning: true, thinkingFormat: "openai" },
    "claude-fable-5": { vision: true, reasoning: true, thinkingFormat: "openai" },
    "ox/ox-alpha": { vision: false, reasoning: true, thinkingFormat: "openai" },
    "ox-alpha": { vision: false, reasoning: true, thinkingFormat: "openai" },
  },
  "freebuff": {
    "openai/gpt-5.6-luna": { vision: true, reasoning: true, thinkingFormat: "openai", contextWindow: 1000000, maxOutput: 128000 },
    "gpt-5.6-luna": { vision: true, reasoning: true, thinkingFormat: "openai", contextWindow: 1000000, maxOutput: 128000 },
